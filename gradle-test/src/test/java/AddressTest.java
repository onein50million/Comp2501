...
class AddressTest
{
    ...
    void getUnitNumber()
    {
        assertEquals("1a", address1.unitNumber());
        assertNull(address2.unitNumber());
    }

    @Test
    void getStreetNumber()
    {
        assertEquals(777, address1.streetNumber());
        assertEquals(123, address2.streetNumber());
    }

    @Test
    void getStreetName()
    {
        assertEquals("56th avenue", address1.streetName());
        assertEquals("main street", address2.streetName());
    }
    ...
    void getCity()
    {
        assertEquals("surrey", address1.city());
        assertEquals("west vancouver", address2.city());
    }
